...
| `wavenet_condition_dsp.nam`     | NAM Core v0.5.2 `condition_dsp` model (MIT). Parity oracle for the nested condition_dsp path (`condition_dsp_matches_namcore_oracle`). |
