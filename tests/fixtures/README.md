...
| `wavenet_condition_dsp.nam`     | NAM Core v0.5.2 `condition_dsp` model (MIT), `condition_size == 3`. Parity oracle for the **multi-channel** nested condition_dsp path (`multi_channel_condition_dsp_matches_namcore_oracle`); input/expected generated by `make_condition_dsp_multi.py`. The mono path uses the self-generated `condition_dsp_mono.nam`. |
